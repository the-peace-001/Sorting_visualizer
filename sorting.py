...
def drawData(data, colorArray):
    ...
    for i, height in enumerate(normalised_data):
        ...
        canvas.create_text(x0+2, y0, anchor=SW, text=str(data[i]), font=("now roman", 15, "bold"), fill="orange")
...
def Generate():
    ...
    #we will take values from our scales
...
mainlabel = Label(root, text="Algorithm: ", font=("new roman", 16, "bold"),
                  bg="#05897A", width=10, fg="black", relief=GROOVE, bd=5)

mainlabel.place(x=0, y=0)

algo_menu = ttk.Combobox(root, width=15, font=("new roman", 19, "bold"), textvariable = selected_algorithm,
                        values=['Bubble Sort', 'Merge Sort', 'Quick Sort'])
algo_menu.place(x=145, y=0)
algo_menu.current(0)

random_generate = Button(root, text="Generate", bg='#2DAE9A', font=('arial', 12, "bold"), relief=SUNKEN,
...
sizevaluelabel = Label(root, text="Size: ", font=("new roman", 12, "bold"),
                  bg="#05897A", width=10, fg="black", height=2, relief=GROOVE, bd=5)
sizevaluelabel.place(x=0, y=60)

sizevalue = Scale(root, from_=0, to=30, resolution=1, orient=HORIZONTAL, font=('arial', 14, "bold"),
                  relief=GROOVE, bd=2, width=10)
sizevalue.place(x=120, y=60)

minvaluelabel = Label(root, text="Min Value: ", font=("new roman", 12, "bold"),
                  bg="#05897A", width=10, fg="black", height=2, relief=GROOVE, bd=5)
minvaluelabel.place(x=250, y=60)

minvalue = Scale(root, from_=0, to=10, resolution=1, orient=HORIZONTAL, font=('arial', 14, "bold"),
                  relief=GROOVE, bd=2, width=10)
minvalue.place(x=370, y=60)

maxvaluelabel = Label(root, text="Max Value: ", font=("new roman", 12, "bold"),
                  bg="#05897A", width=10, fg="black", height=2, relief=GROOVE, bd=5)
maxvaluelabel.place(x=500, y=60)

maxvalue = Scale(root, from_=0, to=100, resolution=1, orient=HORIZONTAL, font=('arial', 14, "bold"),
                  relief=GROOVE, bd=2, width=10)
maxvalue.place(x=620, y=60)


start = Button(root, text="Start", bg='#C45B09', font=('arial', 12, "bold"), relief=SUNKEN,
                         activebackground="#05945B", activeforeground="white", bd=5, width=10,
...
speedscale = Scale(root, from_=0.1, to=5.0, resolution=0.2, length=200, digits=2, orient=HORIZONTAL, font=('arial', 14, "bold"),
                  relief=GROOVE, bd=2, width=10)
